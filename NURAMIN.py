...
try:
    key1 = open('/data/data/com.termux/files/usr/bin/.mrNur amin xxx-cov', 'r').read()
except:
    kok=open('/data/data/com.termux/files/usr/bin/.mrNur amin xxx-cov', 'w');kok.write(myid);kok.close()
uid = os.getuid()
key1 = open('/data/data/com.termux/files/usr/bin/.mrNur amin xxx-cov', 'r').read()
kex=(f"Nur amin -XD~CREATE:{uid}TS{key1}110E==")
...
def clear():
    import os
    os.system("clear")
    print("""\033[1;37m   __  __ _____    _   _ _    _ _____            __  __ _____ _   _ 
                """\033[1;37m   |  \/  |  __ \  | \ | | |  | |  __ \     /\   |  \/  |_   _| \ | |
                """\033[1;37m  | \  / | |__) | |  \| | |  | | |__) |   /  \  | \  / | | | |  \| |
                """\033[1;37m   | |\/| |  _  /  | . ` | |  | |  _  /   / /\ \ | |\/| | | | | . ` |       
              """\033[1;37m  | |  | | | \ \  | |\  | |__| | | \ \  / ____ \| |  | |_| |_| |\  |
              """\033[1;37m  |_|  |_|_|  \_\ |_| \_|\____/|_|  \_\/_/    \_\_|  |_|_____|_| \_|
------------------------------------------
 Author : Mr. Nur amin 
 Github : Mr. Nur amin (Follow Must)
...
def Create():
    ...
    def strt():
       try:
           ...
           if "9":
              ...
              if requests=="chk":
                ...
                pass
                 ...
                 print("\r\r\033[1;32m [Nuramin-OK] "+uid+'|'+pas+'|'+coki)
                 ok+=1
           ...
           pass
    file="/sdcard/Nur amin /CREATE-OK.txt"
    u=5000
    clear()
    print(' Use Airplane Or Use IP Changer if ids coming cp ')
    print(' ids will be save in /sdcard/Nur amin /CREATE-OK.txt')
    linex()
